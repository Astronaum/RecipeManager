...
public class IngredientModalController extends Controller{
    private IngredientModalController(){}
    public static IngredientModalController create(ViewsManager viewsManager) {
        IngredientModalController controller=new IngredientModalController();
